...
(function($, Drupal, window, document, undefined) {
  ...
  Drupal.behaviors.dfus_theme_external_links = {
...
(function($, Drupal, window, document, undefined) {
  ...
  Drupal.behaviors.dfus_theme_menu = {
    attach: function(context, settings) {
...
(function($, Drupal, window, document, undefined) {
  ...
  Drupal.behaviors.dfus_theme_search = {
    attach: function(context, settings) {
...
(function($, Drupal, window, document, undefined) {
  ...
  Drupal.behaviors.dfus_theme_sidebar = {
    attach: function(context, settings) {
...
(function($, Drupal, window, document, undefined) {
  ...
  Drupal.behaviors.dfus_slider = {
    attach: function(context, settings) {
      $slider = $('.view-latest-news-slider > div > ul', context);
      if ($slider.length > 0) {
        ...
        if ($slider.children().length > 1) {
          ...
          owl.play();
          create_custom_controls();
          $('.slider-play').removeClass('paused').html('Pause').attr('title', 'Pause slideshow');
...
(function($, Drupal, window, document, undefined) {
  ...
  Drupal.behaviors.dfus_theme_text_resize = {
    attach: function(context, settings) {
...
(function($, Drupal, window, document, undefined) {
  ...
  Drupal.behaviors.dfus_theme_twitter_theme = {
    attach: function(context, settings) {
...
(function($, Drupal, window, document, undefined) {
  ...
  Drupal.behaviors.dfus_theme_webform = {
    attach: function(context, settings) {
